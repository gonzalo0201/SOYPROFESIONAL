        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col px-6 pt-16 pb-8">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-400 text-sm">
                        {mode === 'login'
                            ...
                            : 'Unite a la comunidad de profesionales'
                        }
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {mode === 'login' && (
                        <div className="text-right">
                            <button type="button" className="text-emerald-400 text-xs font-medium hover:text-emerald-300 transition-colors">
                    ...
                    <button
                        ...
                        className={clsx(
                            ...
                            isLoading
                                ...
                                : "bg-emerald-500 text-white hover:bg-emerald-600 active:scale-[0.98] shadow-lg shadow-emerald-500/25"
                        )}
                    >
                        {isLoading ? (
                ...
                <button
                    ...
                    disabled={isLoading}
                    className="w-full bg-white hover:bg-slate-50 text-slate-800 py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-md"
                >
                ...
                <div className="mt-auto pt-8 text-center">
                    <p className="text-xs text-slate-500">
                        ...
                        <button className="text-emerald-400 font-medium">Términos de uso</button>
                        {' '}y{' '}
                        <button className="text-emerald-400 font-medium">Política de privacidad</button>
                    </p>
                </div>
            </div>
        </div>
